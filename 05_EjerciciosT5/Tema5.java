...
import tema5.daw.zoo.Tigre;
import tema5.daw.zoo.Leon;
import java.time.Instant;
import java.util.Scanner;
import java.util.logging.Level;
import java.util.logging.Logger;
import tema5.daw.zoo.Jaula;
import tema5.daw.zoo.TransporteAnimales;
...
public class Tema5 {
    ...
    public static void main(String[] args){
        ...
        */
        ...
        //Animal a = new Animal("vaca",400);
        Tigre t = new Tigre("manolo",20);
        Tigre t2 = new Tigre("manolo",300);
        Leon l = new Leon("manola",20);
        Leon l2 = new Leon("manola",200);

        Jaula j = new Jaula(2, 40);
        System.out.println(j.añadir(t));
        System.out.println(j.añadir(l));
        System.out.println("Peso máximo: "+j.getPesoMaximo());
        System.out.println("Capacidad máxima: "+j.getCapacidadMaxima());
        System.out.println("Numero de animales: "+j.getNumeroAnimales()+"\n");

        TransporteAnimales ta = new TransporteAnimales();
        System.out.println(ta.añadir(t2));
        System.out.println(ta.añadir(l2));
        System.out.println("Peso máximo: "+ta.getPesoMaximo());
        System.out.println("Capacidad máxima: "+ta.getCapacidadMaxima());
        System.out.println("Numero de animales: "+ta.getNumeroAnimales());
        */

         /*
         EXAMEN

         Coche c = new Coche("33", "azul",5,"audi");
         try {
             c.acelerar(100);
         } catch (Exception ex) {
         ...
         System.out.println(p.procesarCoche(c));
         System.out.println(p.procesarInteger(111));
         System.out.println(p.procesarCadena("hola"));
         System.out.println(p.procesar(l));
         System.out.println("\n"+p);
         */
         ...
         */
         ...
         GeneradorContraseñasArchivo gca = new GeneradorContraseñasArchivo("C:/Users/kevin/Desktop/PRUEBA1.docx");
         ...
         GeneradorContraseñasUnicasArchivo gcua = new GeneradorContraseñasUnicasArchivo("C:/Users/kevin/Desktop/PRUEBA2.docx");

         System.out.println("GeneradorContraseña: "+gc.generarContraseña(7));
         System.out.println("GeneradorContraseña: "+gc.generarContraseña());
         System.out.println("GeneradorContraseñaUnica: "+gcu.generarContraseña());
         System.out.println("GeneradorContraseñaUnica: "+gcu.generarContraseña(7));
         System.out.println("GeneradorContraseñaArchivo: "+gca.generarContraseña());
         System.out.println("GeneradorContraseñaArchivo: "+gca.generarContraseña(7));
         System.out.println("GeneradorContraseñaInvertida: "+gci.generarContraseña(7));
         System.out.println("GeneradorContraseñaRara: "+gcr.generarContraseña(20));
         System.out.println("GeneradorContraseñaUnicaArchivo: "+gcua.generarContraseña(0));
